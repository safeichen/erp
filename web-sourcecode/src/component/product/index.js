...
class Product extends Component {
    ...
    listProduct = () => {
        ...
        let result = this.props.listProduct(this.state.queryCondition, pagination.current || 1, pagination.pageSize || 20);
        if(!result) {
            return;
        }
            ...
            <div>
                ...
                <div className="query_box">
                    ...
                    <Table className="v-table" locale={{ emptyText: '暂无数据' }} pagination={this.state.pagination}
                        dataSource={this.state.products} onChange={this.onChangePage}>
...
export default connect(erpState, erpAction)(Product);
